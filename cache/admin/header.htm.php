...
<div id="dcHead">
 <div id="head">
  <div class="logo"><a href="index.php"><img src="images/logo2.png" alt="logo" height="50" width="150" style="margin-top:-2px;"></a></div>
  <div class="nav">
   <ul>
    ...
    <li class="noRight"><a href="index.php?rec=clear_cache"><?php echo $this->_tpl_vars['lang']['clear_cache']; ?>
</a></li>
    <li><a href="http://help.douco.com" target="_blank"></a></li>
    <li>
     <a href="module.php"<?php if ($this->_tpl_vars['cur'] == 'module'): ?> class="cur"<?php endif; ?>>
     </a>
    </li>
   </ul>
   <ul class="navRight">
