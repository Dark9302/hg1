...
"><img src="http://localhost/dou/upload/theme/default/images/<?php echo $this->_tpl_vars['site']['site_logo']; ?>
...
"<?php if ($this->_foreach['nav_middle_list']['iteration'] == 4): ?> class="last"<?php endif; ?><?php if ($this->_tpl_vars['nav']['target']): ?> target="_blank"<?php endif; ?>><?php echo $this->_tpl_vars['nav']['nav_name']; ?>
</a>
  <?php if ($this->_tpl_vars['nav']['child']): ?>
  <ul>
   <?php $_from = $this->_tpl_vars['nav']['child']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
